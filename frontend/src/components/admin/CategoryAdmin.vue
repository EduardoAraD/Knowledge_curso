...
export default {
    ...
    methods: {
        ...
        save() {
            const method = this.categoty.id ? 'put' : 'post'
            const id = this.categoty.id ? `/${this.categoty.id}` : ''
            axios[method](`${baseApiUrl}/categories${id}`, this.categoty)
                .then(() => {
